...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWtzaGF0LXRyaXYiLCJhIjoiY2tkdzFjbzBnMHdjcDJ1c2dsMnZoZmliMSJ9.TvRX7m7ZUfzW7D6fPPaNhg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/akshat-triv/ckdw5r6uv2su119nw6vcq9m23',
    scrollZoom: false //   center: [-118.192043, 34.02699],
    //   zoom: 10,
    //   interactive: false
...
var sendAlert = function sendAlert(status, message) {
  hideAlert();
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.sendAlert)('success', 'Logged in successfuly');
          ...
          case 7:
            ...
            (0, _alerts.sendAlert)('error', _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.sendAlert)('success', 'Logged out successfuly');
              window.setTimeout(function () {
                location.assign('/');
              }, 3000);
            }
          ...
          case 7:
            ...
            (0, _alerts.sendAlert)('error', 'Error in logging out! Try again later');
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return _context3.abrupt("return", (0, _alerts.sendAlert)('error', 'Password confirm does not match.'));
          ...
          case 5:
            ...
            //console.log(res.data);
            if (res.data.status === 'success') {
              (0, _alerts.sendAlert)('success', 'Signed in successfuly');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
          ...
          case 9:
            ...
            (0, _alerts.sendAlert)('error', _context3.t0.response.data.message);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.sendAlert)('success', res.data.message);
            }
          ...
          case 7:
            ...
            (0, _alerts.sendAlert)('error', _context4.t0.response.data.message);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.sendAlert)('success', "Password updated successfully!");
              window.setTimeout(function () {
                location.assign('/');
              }, 3000);
            }
          ...
          case 7:
            ...
            (0, _alerts.sendAlert)('error', _context5.t0.response.data.message); //console.log(err.response.data.message);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.sendAlert)('success', "".concat(type, " updated successfully!"));
              window.setTimeout(function () {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.sendAlert)('error', _context.t0.response.data.message); //console.log(err.response.data.message);
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51HJ3OOFU8VajapjJ52gh772aPbxgEV6P5grwE8H4TPQak6Mwl0WbHm1GLEmMN2E7BdX7IKHOdMJXWFXj0vGkZTDK00z6MpDiua');
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("/api/v1/booking/session-checkout/".concat(tourId));
          ...
          case 9:
            ...
            (0, _alerts.sendAlert)('error', _context.t0);
...
var form = document.querySelector('.form-login') ? document.querySelector('.form-login') : document.querySelector('.form-signup') ? document.querySelector('.form-signup') : document.querySelector('.form-forgot');
var formReset = document.querySelector('.form-reset');
var logoutBtn = document.querySelector('.nav__el--logout');
var formUser = document.querySelector('.form-user-data');
var formSettings = document.querySelector('.form-user-settings');
...
if (formUser) {
  formUser.addEventListener('submit', function (e) {
    ...
    (0, _update.updateSettings)(form, 'Profile');
  });
}

if (formReset) {
  var token = formReset.dataset.token;
